...
import com.chugay.cartech.databinding.CartViewHolderBinding
import com.chugay.cartech.model.Cart

class RvCartAdapter(
    private val cartList: List<Cart>,
    private val listener: (cart: Cart) -> Unit
) : RecyclerView.Adapter<RvCartAdapter.MyViewHolder>() {
    class MyViewHolder(
        listener: (cart: Cart) -> Unit,
