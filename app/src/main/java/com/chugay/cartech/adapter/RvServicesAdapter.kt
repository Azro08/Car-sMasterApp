...
class RvServicesAdapter
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(
            listener,
            ClientServiceViewViewholderBinding.inflate(
